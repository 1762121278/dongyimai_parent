...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public Specification findOne(Long id){
		...
		//构建组合实体类返回结果
		Specification pecification=new Specification();
		pecification.setSpecification(tbSpecification);
		pecification.setSpecificationOptionList(specificationOptionList);
		return pecification;
	}
